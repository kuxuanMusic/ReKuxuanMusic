	...
	if (data.menus == null)
		...
		$.each(data.menus, function(i, sm) {
			if (sm.url != null) {
				...
				menulist += '<li state="closed"><span class="nav">'
						+ sm.menuname + '</span>'
			}
	...
	$
			.each(
					...
					function(i, sm) {
						...
						menulist1 = "<ul id='tt1' class='easyui-tree' animate='true' dnd='true'>"
...
var _menus = {
	basic : [ {
		...
		"menus" : [ {
			...
			"menuname" : "所有歌手",
			"icon" : "icon-nav",
			"url" : "SingerServlet?op=SingerPage&pageNo=1&pageSize=10"
		}, {
			"menuid" : "113",
			"menuname" : "新增歌手",
			"icon" : "icon-nav",
		...
		"menus" : [ {
			...
			"menuname" : "所有专辑",
			"icon" : "icon-nav",
			"url" : "AlbumServlet?op=albuminfoFenye&pageNo=1&pageSize=5"
		}, {
			"menuid" : "213",
			"menuname" : "新增专辑",
			"icon" : "icon-nav",
			...
			"menuname" : "所有专辑类型",
			"icon" : "icon-nav",
			"url" : "AlbumServlet?op=albumTypeinfoFenye&pageNo=1&pageSize=5"
		}, {
			"menuid" : "213",
			"menuname" : "新增专辑类型",
			"icon" : "icon-nav",
			"url" : "addAlbumType.jsp"
		} ]
	}, {
		"menuid" : "30",
		"icon" : "icon-sys",
		...
		"menus" : [ {
			...
			"menuname" : "所有歌曲类型",
			"icon" : "icon-nav",
			"url" : "MusicServlet?op=musicFenye&page=1&pageSize=10"
		}, {
			"menuid" : "313",
			"menuname" : "新增歌曲类型",
			"icon" : "icon-nav",
			...
			"menuname" : "所有MV",
			"icon" : "icon-nav",
			"url" : "MVServlet?op=mvpaging&pageNo=1&pageSize=5"
		}, {
			"menuid" : "351",
			"menuname" : "新增MV",
			"icon" : "icon-nav",
